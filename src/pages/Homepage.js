      ...
      <div>
          ...
          <div class="  items-center  px-16 py-7  ">
            ...
            <div class="md:place-self-center grid grid-flow-row ">
              ...
              <div class=" md:w-1/3 md:place-self-center place-content-center grid gap-2 md:gap-2 md:grid-flow-col ">
                <Buttons
               class=" rounded-sm    bg-gradient-to-r from-blue-200 via-blue-100 to-blue-100 text-white ">
                  Get started
                </Buttons
              >
                <Buttons
               class=" rounded-sm   bg-cyan-100 text-cyan-800">
                  Learn more
                </Buttons
              >
              </div>
        ...
        <div class="   md:-mt-28 items-center  px-16 py-7 ">
          ...
          <div class=" clear-both ">
            ...
            <div class=" md:mt-36 mt-20 lg:float-left lg:w-5/12">
              <HText class=" font-bold  text-4xl ">Sign Up</HText>
              ...
              <Buttons
             class=" mt-4 mb-10 md:mb-0 float-left rounded-sm  bg-gradient-to-r from-blue-200 via-blue-100 to-blue-100 text-white ">
                Learn more
              </Buttons
            >
              <svg
        ...
        <div class=" mt-44 md:pl-0  md:w-auto -mb-20  place-content-center grid grid-flow-row  h-96">
          ...
          <div class="md:mb-32 grid place-self-center sm:grid-flow-row sm:grid-cols-2 sm:gap-0   mb-40 gap-8 md:gap-10 grid-cols-2 lg:grid-flow-col lg:grid-rows-2">
            <Companies img="https://i.postimg.cc/tC3rNpGk/Group.png"></Companies>
            <Companies img="https://i.postimg.cc/W46fpVXt/Walmart-Logo.png"></Companies>
            <Companies img="https://i.postimg.cc/W31S2kdf/Vector.png"></Companies>
            <Companies img="https://i.postimg.cc/CKL6KttN/Fed-Ex-Logo.png"></Companies>
            <Companies img="https://i.postimg.cc/3wMkB5j8/Microsoft-Logo.png"></Companies>
            <Companies img="https://i.postimg.cc/V60grcFj/Amazon-Logo.png"></Companies>
            <Companies img="https://i.postimg.cc/X7mPQQrN/OYO-Logo-1.png"></Companies>
            <Companies img="https://i.postimg.cc/GmpkTCLH/Google-Logo.png"></Companies>
          </div>
        </div>
        ...
        <div class="lg:mt-16 mt-40 place-content-center  text-white ">
          ...
          <div class="grid grid-flow-row grid-cols-2 gap-8   lg:-mt-20 sm:place-self-center sm:grid-flow-row sm:gap-8 sm:grid-cols-2 lg:grid-flow-col lg:grid-rows-1 lg:grid-cols-4 items-center place-self-center ">
            <Marketing heading="40+" parag="Happy Clients"></Marketing>
            <Marketing heading="540+" parag="Projects Completed"></Marketing>
            <Marketing heading="300" parag="Dedicated Members"></Marketing>
            <Marketing heading="25+" parag="Awards Won"></Marketing>
          </div>
        </div>
        <div class="mt-24 md:mb-20 text-center grid grid-flow-row  h-96">
          ...
          <Buttons
         class="place-self-center rounded-sm  bg-gradient-to-r from-blue-200 via-blue-100 to-blue-100 text-white ">
            Download Now
          </Buttons
        >
        </div>
